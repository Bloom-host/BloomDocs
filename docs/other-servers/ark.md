...
![ARK server port requirements listed in a table](/other-servers/ARK/1.jpeg)
...
![Ports and Proxies configured with ARK game, query, and RCON ports](/other-servers/ARK/2.png)
...
![ARK server options on the DuckPanel Startup tab](/other-servers/ARK/3.png)
...
![ARK server query and RCON port fields](/other-servers/ARK/4.png)
...
2. Click on the **Unofficial Servers** tab, search for your server, then join.
