...
First you'll need to create an account in our [Billing Portal](https://billing.bloom.host/).
...
![VirtFusion Shared Access form with a token and Grant Access button](/VPS/virtfusion-subuser/2.png)
