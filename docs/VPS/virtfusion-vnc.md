...
![VirtFusion dashboard with a VPS selected](/VPS/virtfusion-vnc/1.png)
...
![VirtFusion Options tab showing the VNC setting](/VPS/virtfusion-vnc/2.png)
...
![VirtFusion VNC console open for the selected VPS](/VPS/virtfusion-vnc/3.png)
...
![VirtFusion VNC clipboard and paste controls](/VPS/virtfusion-rescue/4.png)
