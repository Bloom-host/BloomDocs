...
![VirtFusion Media tab with the Windows Server image available](/VPS/virtfusion-windows-install/InstallWindowsVirt1.png)
...
![Windows Server installer open in the VirtFusion VNC console](/VPS/virtfusion-windows-install/InstallWindowsVirt2.png)
...
![Windows installer at the driver selection step](/VPS/virtfusion-windows-install/InstallWindowsVirt3.png)
![VirtFusion Media tab with the VirtIO driver image inserted](/VPS/virtfusion-windows-install/InstallWindowsVirt4.png)
...
![VirtIO guest tools installer open in Windows](/VPS/virtfusion-windows-install/InstallWindowsVirt5.png)
