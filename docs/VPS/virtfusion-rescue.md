...
![Rescue mode console displaying the login prompt](/VPS/virtfusion-rescue/3.png)
...
![Rescue mode credentials in the Bloom.host email](/VPS/virtfusion-rescue/4.png)
...
![VirtFusion control for disabling rescue mode](/VPS/virtfusion-rescue/5.png)
