...
`distance` - This is the radius in which people will see your message. E.g. If this is set to 5, people only within five blocks from all directions of you will see a message you have sent.
