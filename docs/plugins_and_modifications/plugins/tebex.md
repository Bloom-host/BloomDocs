...
Once you have done this, please upload the .jar file into your `/plugins` folder. For further assistance, refer to our [plugin installation guide](/installing-plugins).

---

## Usage

In order to integrate your Tebex Store with your Minecraft server, you need your Tebex secret key. To obtain the secret key, open the [Tebex server settings](https://server.tebex.io/settings/servers/1083138) and log in to your dashboard.
