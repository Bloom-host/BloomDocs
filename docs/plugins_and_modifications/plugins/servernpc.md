...
ServerNPC is a plugin that allows you to create non-player characters, or NPCs, and have them do certain actions.
...
To create an NPC run the "/npc create \{ID} \{Skin}" command. ID is the name of the NPC, and the skin is the name of the skin the NPC will use. If you choose not to use a player's skin you can also use skins from [MineSkin.org](https://mineskin.org/)

---

## Editing Wand
If you open the menu that appears in /npc, and right click the "See NPCs" button, it will give you an editing wand. This has many functions.
