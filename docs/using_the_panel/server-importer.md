...
- Fill out the form with the appropriate credentials.
...
:::note
This method only works if your former provider offers backups with the option to download them directly from a link.
:::
...
- If the link is direct, then the download will begin. Once it's completed, your backup archive will be available in your server's home directory.
