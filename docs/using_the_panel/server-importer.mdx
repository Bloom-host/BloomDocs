...
description: Import files and databases from another game host using DuckPanel's Server Importer.
keywords:
  - Server Importer
  - Import server
  - Migrate
...
<div style={{ position: 'relative', paddingTop: '56.25%', textAlign: 'center' }}>
  <iframe
    src="https://www.youtube.com/embed/pkaASL6Xros?si=XUdlLLzRMGGoU2bF"
    title="Bloom.host Server Importer walkthrough"
    frameBorder="0"
...
- First go to [DuckPanel](https://mc.bloom.host)
...
![DuckPanel console showing Server Importer progress](/using_the_panel/server-importer/1.png)
...
- In DuckPanel, go to File Manager, then click the top right button "Download From URL".
