...
---
:::warning
## Reverse proxies can only be used for *web connections* (e.g. HTTPS). If you want to join your Minecraft server using your domain, check our [domain guide](/domain)
:::
:::note
...
![Cloudflare CNAME record configured for a root domain](/using_the_panel/ports_and_proxies/1.png)
...
![Cloudflare CNAME record configured for a subdomain](/using_the_panel/ports_and_proxies/2.png)
...
![DuckPanel Ports and Proxies tab with proxy controls](/using_the_panel/ports_and_proxies/3.png)
