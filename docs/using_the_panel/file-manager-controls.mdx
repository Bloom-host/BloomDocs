...
description: Learn how to upload, download, archive, restore, and manage server files in DuckPanel.
keywords:
  - File Manager
  - Files
  - Upload files
...
<div style={{ position: 'relative', paddingTop: '56.25%', textAlign: 'center' }}>
  <iframe
    src="https://www.youtube.com/embed/Dgl5JNRju-A?si=howzfCpQT7hsEfyo"
    title="Bloom.host File Manager controls walkthrough"
    frameBorder="0"
...
![DuckPanel File Manager showing the current server path and files](/using_the_panel/file_manager_controls/1.png)
...
- Delete files. By default, this will send files to the Recycle Bin (space permitting) for 24 hours or until manually purged.
