...
Start by heading over to the [GitHub Releases page](https://github.com/ClumsyAdmin/ClumsyLoader/releases), and downloading the appropriate version for your OS. In this example, we will use `Bloomloader_windows_amd64.exe`, which is the executable for Windows. Once you have downloaded ClumsyLoader, make sure to create a new folder and put the executable in it.
...
![DuckPanel Account API page](/extras/srvcontrol/1.png)
...
![DuckPanel API key creation form and key reveal control](/extras/srvcontrol/2.png)
