...
Once you found the resource pack you want on your server you need to upload the resource pack to a website and get the direct download link of it. You can use [MC-Packs](https://mc-packs.net/).
...
![File hosting page with a resource pack selected for upload](/running_a_server/resourcepack/1.png)

Once done you’ll get your download URL. (save this URL)

![Uploaded resource pack with its download URL](/running_a_server/resourcepack/2.png)
...
![server.properties resource-pack field containing the download URL](/running_a_server/resourcepack/4.png)
...
![server.properties resource-pack-sha1 field containing the checksum](/running_a_server/resourcepack/4.png)
