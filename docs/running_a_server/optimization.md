...
For the Bukkit platform you mave many options for a server jar, the most stable of which is [Paper](https://papermc.io). Paper includes many performance improvements, bug fixes and configuration options. If you want peformance tewaks on top that can be powerful but may break the more technical mechanics or quality of life tweaks try [Purpur](https://purpurmc.org/downloads).
