...
![Online image editor upload page](/running_a_server/icon/1.png)
...
![Image editor with URL and file upload controls](/running_a_server/icon/2.png)

3. Your image should pop up in the upper right-hand corner as seen below:

![Uploaded server icon in the image editor](/running_a_server/icon/3.png)

4. You will then need to click and drag the little boxes to fit the part of the image you want to include.

![Crop handles positioned around the server icon](/running_a_server/icon/4.png)
...
![Image editor configured to export a 64 by 64 icon](/running_a_server/icon/5.png)
...
![DuckPanel File Manager open for the server](/running_a_server/icon/6.png)

7. Click upload and pick the icon you made, make sure you name the file exactly server-icon.png or this will not work.

![File Manager showing the uploaded server-icon.png file](/running_a_server/icon/7.png)
