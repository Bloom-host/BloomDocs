...
<div class="text--center"><img src={require('../../static/imgs/running_a_server/internal_servers/1.png').default} alt="console" height="70%" width="70%"/></div>
...
<div class="text--center"><img src={require('../../static/imgs/running_a_server/internal_servers/2.png').default} alt="console" height="70%" width="70%"/></div>
...
<div class="text--center"><img src={require('../../static/imgs/running_a_server/internal_servers/3.png').default} alt="console" height="70%" width="70%"/></div>
