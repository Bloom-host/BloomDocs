...
![Ports and Proxies tab with the Make Internal button](/running_a_server/internal_servers/1.PNG)
...
![Velocity split with internal backend servers](/running_a_server/internal_servers/2.PNG)
...
![Internal backend server with a public Dynmap port](/running_a_server/internal_servers/3.PNG)
