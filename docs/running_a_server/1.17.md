...
### Introduction
<div class="text--center">
<img src="../../static/imgs/running_a_server/1.17/1.png" alt="logo" height="40%" width="40%" class="float-right"/>
</div>

With the release of 1.17, the first part of the Caves & Cliffs update quite a few internal changes were made to the game.

With every update it takes a while for softwares such as Spigot and forks of it to update and support all the changes. Unfortunately it's not possible to have a set ETA for 1.17 support but you can keep track of updates on [SpigotMC.org](https://www.spigotmc.org) or on  [PaperMC's GitHub](https://github.com/PaperMC/Paper/issues/5785)!
...
<div class="text--center">
<img src="../../static/imgs/running_a_server/1.17/2.png" alt="logo" height="50%" width="50%"/>
</div>
...
- Make sure to your server completely.
