...
We can start by heading over to their [web site](https://srvcontrol.xyz/) and inviting the bot to a discord server that you are the owner or admin of. After inviting it to your server with the proper permissions, go to that discord server and type ```.register``` in one of the channels. This will initiate 
